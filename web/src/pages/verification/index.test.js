...
describe('Verification', () => {
  ...
  it('should render form fetch is success', async () => {
    ...
    expect(component.find('form').find('input').props().placeholder).toEqual(
  ...
  it('should submit form', async (done) => {
    ...
    setTimeout(() => {
      expect(document.querySelector('form').getAttribute('action')).toEqual(
  ...
  it('should trigger storage event listener', async () => {
    ...
    expect(image.prop('src')).toEqual(
      'https://images.factly.in/login/applications/logos/dega.png?rs:fill/h:35',
    );
  });
  it('should submit code form', async (done) => {
    ...
    component
      ...
      .find('input')
      .at(0)
      .simulate('change', { target: { value: '123450' } });
